...
;(function () {
  ...
  var _FLAGS = {
    ...
    de: '<svg viewBox="0 0 16 11" style="width:16px;height:11px;vertical-align:middle;margin-right:.3rem"><rect width="16" height="3.67" fill="#000"/><rect y="3.67" width="16" height="3.67" fill="#D00"/><rect y="7.33" width="16" height="3.67" fill="#FC0"/></svg>',
